...
*The default media directory is `/srv/media`, you have configured the guide to use [[media_path]] instead.*
...
*The default installation directory is `/opt/yams`, you have configured the guide to use [[install_path]] instead.*

...
### 1. Dozzle exposes unauthenticated container control
...
### 3. Production installation remains controlled by `not-first/v3`
...
### 5. The documentation says rerunning the installer is safe, but it overwrites configuration
...
### 6. Core setup instructions disagree with the new stack
...
### 8. Important replacement content remains unfinished
...
### 9. Custom-container networking documentation describes a network v3 removed
...
### 11. Imported assets include definite artifacts
...
### 12. Security follow-up: public screenshots show complete API keys
